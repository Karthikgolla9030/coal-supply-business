...
from .views import BusinessProfileViewSet, CustomerViewSet, InvoiceViewSet

# ── Business Profile (singleton resource) ──────────────────
business_profile_list = BusinessProfileViewSet.as_view(
    {"get": "retrieve_profile"}
)
business_profile_create = BusinessProfileViewSet.as_view(
    {"post": "create_profile"}
)
business_profile_update = BusinessProfileViewSet.as_view(
